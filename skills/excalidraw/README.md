...
![Vault note half-life](examples/vault-note-half-life.png)

> Generated end-to-end by the skill itself. Source: [`examples/vault-note-half-life.excalidraw`](examples/vault-note-half-life.excalidraw)
