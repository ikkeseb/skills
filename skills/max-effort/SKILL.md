...
- **Check load-bearing claims against source-of-truth.** Read the cited file, open the URL, run the tests/build/repro, look at the browser. Task-specific, with the CLAUDE.md verification bar not relaxed.
